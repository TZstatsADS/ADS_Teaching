...
author: "Yujie Wang, Chengliang Tang, Tian Zheng"
output:
...
- Google offers $300 credit and 12-month free trail for GCP product. Register [here](https://cloud.google.com).
...
```
This process might take a while. Once installation is complete, leave the R command line:
```sh
quit()
```
...
```sh
http://[your_external_ip](https://console.cloud.google.com/compute/instances):8787
```
...
```
- To verify if the installation is complete, you can access 
```sh
http://your_external_ip:3838
```
