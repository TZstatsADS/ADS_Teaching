...
#### Advanced Model
Advanced Features: SIFT(1, 2, 3), HOG(1, 2), LBP(1, 10), RGB(2, 3, 5, 7, 8, 9), CNN(4)
```{r, echo=FALSE}
featureDim_bl <- c(2080, 3041, 3729, 1, 600, 600, 2000, 512, 1000, 59)
...
### Running Time
Advanced models: XGBoost(1, 2, 3, 5, 8, 9), GBM(6, 7), Logistic Regression(10), CNN(4)
```{r, echo=FALSE}
# run Results.R first
